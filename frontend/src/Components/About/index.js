        ...
        <div className='container'>
          <section className='about-content-section'>
            ...
            <p className='about-content__p'>
              ...
              что-то выгодное. Мы делаем это как первый шаг, чтобы
              познакомиться.
            </p>
            <p className='about-content__p'>
          ...
          <section className='about-content-section'>
            ...
            <p className='about-content__p'>
              ...
              километров друг от друга. Это наш случай, у нас их вон уже
              сколько:
            </p>
            <img
          ...
          <section className='about-content-section'>
            ...
            <p className='about-content__p'>
              ...
              работает. Нужна сила, благодаря которой стандарты будут
              соблюдаться. Для нас этой силой стала открытость. Мы сделали всё
              настолько прозрачным, что отступать от стандартов просто не
              получается.
            </p>
          ...
          <section className='about-content-section'>
            ...
            <p className='about-content__p'>
              ...
              маврикийские дронты, были очень доверчивыми и наивными, и вымерли
              в конце семнадцатого века с приходом колонизаторов.
            </p>
            <img
          ...
          <section className='about-content-section'>
            <p className='about-content__p'>
              Если вы испытываете похожие чувства — прочитайте нашу книгу, и
              может быть мы станем друзьями. Если считаете, что это полная
              ерунда и так не бывает — всё равно прочитайте и расскажите, что
              думаете.
            </p>
            <Link
