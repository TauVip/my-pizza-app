      ...
      <div className='modal-login__form'>
        ...
        <div className='modal-login__phone'>
          ...
          {!dispatchPhone ? (
            <>
              ...
              />
              {phoneError && (
                <div className='input-error_anchor visible'>
            ...
            <div className='phone-input-wrapper'>
              <input className='phone-input-send' value={input} disabled />
              <span className='phone-input-change'>Изменить</span>
            </div>
          )}
        </div>
        ...
        {!dispatchPhone ? (
          ...
          <div style={{ position: 'relative' }}>
            ...
            {codeTiming ? (
              <span>Получить новый код через {time} сек.</span>
            ) : (
              <span className='code-text' onClick={() => setCodeError(true)}>
                Получить новый код
              </span>
            )}
            {codeError && (
